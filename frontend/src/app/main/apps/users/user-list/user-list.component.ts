...
export class UsersUserListComponent implements OnInit, OnDestroy
{
    ...
    displayedColumns = ['name', 'email', 'password', 'phone', 'address', 'created_at', 'buttons'];
    selectedUsers: any[];
    checkboxes: {};
    dialogRef: any;
    ...
    deleteUser(user): void
    {
        ...
        this.confirmDialogRef.componentInstance.confirmMessage = 'Estas seguro que deseas eliminar?';
